...
void solve()
{
    ...
    insertion(&linkedlist2,10);
    insertion(&linkedlist2,1);
    insertion(&linkedlist2,20);
    insertion(&linkedlist2,33);
    insertion(&linkedlist2,23);
    insertion(&linkedlist2,13);
    insertion(&linkedlist2,134);
    insertion(&linkedlist2,123);
    insertion(&linkedlist2,234);
    insertion(&linkedlist2,256);
    insertion(&linkedlist2,65);
    insertion(&linkedlist2,134);
    mergelist(&linkedlist,&linkedlist2);
    print(linkedlist);
}
signed main()
{
